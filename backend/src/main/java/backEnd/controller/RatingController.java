...
public class RatingController {
    ...
    @ApiMethod(description = "Method user to update Freldo ICO rating")
    public void updateRating() throws IOException {
        ratingService.updateRating();
    }

    @RequestMapping(value = "", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiMethod(description = "Method user to get Freldo ICO rating from all web-sites")
    public RatingsResponse getRating() throws IOException, InterruptedException {
